...
let UI = exports.UI =
{
  ...
  /**
   * Gets called once the initialization is finished and Hola adblock elements
  ...
  /**
   * Initializes Hola adblock UI in a window.
   */
  ...
  /**
   * Removes Hola adblock UI from a window.
   */
  ...
  /**
   * Iterator for application windows that Hola adblock should apply to.
   * @type Iterator
   */
  ...
  /**
   * Updates Hola adblock icon state for all windows.
   */
  ...
  /**
   * Updates Hola adblock icon state for a single application window.
   */
  ...
  /**
   * Toggles the pref for the Hola adblock sync engine.
   ...
   * pop-ups related to Hola adblock.
   */
  ...
  /**
   * Adds Hola adblock menu items to the content area context menu when it shows
   * up.
   */
